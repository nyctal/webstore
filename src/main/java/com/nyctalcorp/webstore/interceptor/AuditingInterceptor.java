package com.nyctalcorp.webstore.interceptor;

/**
 * Created by Giacinto on 03/05/2016.
 */
...
public class AuditingInterceptor extends HandlerInterceptorAdapter {
    ...
    public void
    afterCompletion(HttpServletRequest request,HttpServletResponse response, Object handler,Exception arg3) throws Exception {
